...
*/
        ...
        public static NewsItem MakeRssItem(feedsFeed f, XmlReader reader, object[] atomized_strings,
        ...
        /// <param name="defaultItemDate">The default item date to be used if there is no/invalid date information on an item.</param>
        /// <returns>An NewsItem object containing the information in the XmlReader passed in.</returns>
        public static NewsItem MakeAtomItem(feedsFeed f, XmlReader reader, object[] atomized_strings,
                                            DateTime defaultItemDate)
        {
            ContentType ctype = ContentType.None;
            string description = null;
...
//			_log.Info(iSize.ToString() + "\t byte(s) contained in feed\t" + f.link);
    ...
    // not that of the HTTP header:
        ...
        private static void ProcessFeedElements(feedsFeed f, XmlReader reader, object[] atomized_strings, string rssNamespaceUri, SyndicationFormat format, ref string feedLink, ref string feedTitle, ref string feedDescription, ref DateTime channelBuildDate, IDictionary<XmlQualifiedName, string> optionalElements, ICollection<NewsItem> items, DateTime defaultItemDate, ref string language)
        {
