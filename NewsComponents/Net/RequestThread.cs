...
/*
 * $Id: RequestThread.cs,v 1.3 2005/03/30 14:19:59 t_rendelmann Exp $
 * Last modified by $Author: t_rendelmann $
 * Last modified at $Date: 2005/03/30 14:19:59 $
 * $Revision: 1.3 $
 */
#endregion
...
#if TEST_REQUESTTHREADRUNEX
			Thread thread = new Thread(new ThreadStart(RunEx));
#else
