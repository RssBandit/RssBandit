...
/*
 * $Id: RemoteFeedlistThreadHandler.cs,v 1.59 2007/07/26 02:47:20 carnage4life Exp $
 * Last modified by $Author: carnage4life $
 * Last modified at $Date: 2007/07/26 02:47:20 $
 * $Revision: 1.59 $
 */
#endregion
				...
				using (MemoryStream tempStream   = new MemoryStream()) {
					...
					switch (remoteProtocol) {
						...
						case RemoteStorageProtocolType.NewsgatorOnline:					
							...
							lws.Credentials = pws.Credentials = fws.Credentials = sws.Credentials = new System.Net.NetworkCredential(credentialUser, credentialPassword);						
							lws.Proxy = pws.Proxy = fws.Proxy = sws.Proxy = rssBanditApp.Proxy;
							...
							lws.NGAPITokenValue.Token = pws.NGAPITokenValue.Token = fws.NGAPITokenValue.Token = sws.NGAPITokenValue.Token = RemoteFeedlistThreadHandler.NgosProductKey;
